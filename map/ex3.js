...
const test = array.map(function(objects){
    ...
    if (objects.rating < 60 ){
      objects.label = "rotten";
    }
    if(objects.rating >= 60 && objects.rating <= 75){
      objects.label = "fresh";
    }
    if (objects.rating > 75){
      objects.label = "certified fresh";
